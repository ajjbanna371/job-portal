    ...
    <Card className="hover:shadow-md transition cursor-pointer">
      <CardContent className="space-y-3 p-4">
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    the job listing for <span className="font-semibold text-foreground">
                      "{job.title}"</span>.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                  <AlertDialogAction className="bg-destructive text-destructive-foreground hover:bg-/10" onClick={() => onDelete?.(job.id)}>
                    Delete
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
        ...
        <div className="flex flex-wrap gap-2 text-sm">
          ...
          {/* <Badge variant="secondary">{job.minEducation}</Badge> */}
        </div>
        ...
        {job.expiresAt != null && (
          <Badge variant="destructive">
            Expires on {new Date(job.expiresAt).toLocaleDateString("en-IN")}
          </Badge>
        )}
      </CardContent>
    </Card>
