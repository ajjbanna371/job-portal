...
export const employerProfileSchema = z.object({
    ...
    .string()
    .trim()
    .min(2, "Company name must be at least 2 charatcters long")
    .max(255, "Company name must not exceed 255 characters"),

    description: z
    .string()
    .trim()
    .min(10, "Description must be at least 10 charatcters long")
    ...
    .optional()
    .or(z.literal("")), // here empty string would fall under minimum length validation, so user will see error if they clean the field
    ...
    // It allows empty strings as valid input because zod's optional() doesn't consider empty string as undefined.
